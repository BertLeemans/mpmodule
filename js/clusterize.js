...
;(function(name, definition) {
  ...
  var Clusterize = function(data) {
    ...
    // public parameters
    self.options = {};
    var options = ['rows_in_block', 'blocks_in_cluster', 'verify_change', 'show_no_data_row', 'no_data_class', 'no_data_text', 'keep_parity', 'tag', 'callbacks', 'extra_row_data'];
  ...
  Clusterize.prototype = {
    ...
    renderExtraTag: function(class_name, height) {
      ...
      //tag.append($.parseHTML(this.options.extra_row_data)[0]);
      tag.innerHTML = this.options.extra_row_data;
